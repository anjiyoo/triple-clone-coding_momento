...
class Trip(models.Model):
    ...
    city = models.ForeignKey(County,on_delete=models.SET_NULL, null=True)
...
class CitySpot(models.Model):
    city = models.ForeignKey(County, on_delete=models.CASCADE, related_name='tour_spots')
...
class DayPlan(models.Model):
    trip = models.ForeignKey(Trip,on_delete=models.CASCADE)
    spot = models.ForeignKey(CitySpot,on_delete=models.CASCADE,null=True)
